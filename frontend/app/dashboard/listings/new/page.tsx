      ...
      <div className="container mx-auto px-4 py-8">
        ...
        <div className="max-w-3xl mx-auto">
          <div className="mb-8">
            ...
            <p className="text-muted-foreground">Share your unique experience with travelers</p>
          </div>
          ...
          <form onSubmit={handleSubmit}>
            <Card>
              <CardHeader>
                ...
                <CardDescription>Provide information about your tour</CardDescription>
              </CardHeader>
              <CardContent className="space-y-6">
                ...
                <div className="space-y-2">
                  ...
                  <Textarea id="description" placeholder="Describe what makes your tour special..." rows={5} required />
                </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                  ...
                  <div className="space-y-2">
                    ...
                    <Input id="maxGroupSize" type="number" placeholder="8" min="1" required />
                  </div>
                </div>

                <div className="space-y-2">
                  <Label htmlFor="meetingPoint">Meeting Point *</Label>
                  <Input id="meetingPoint" placeholder="e.g., Jackson Square, Main Entrance" required />
                </div>
