  ...
  return (
    <div className="flex flex-col">
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-3xl mx-auto text-center space-y-8">
            ...
            <p className="text-xl text-muted-foreground text-pretty">
              Discover authentic experiences, hidden gems, and unforgettable adventures guided by passionate locals who
              know their cities best.
            </p>

            <div className="flex flex-col sm:flex-row gap-4 max-w-2xl mx-auto">
              <div className="relative flex-1">
                <Search className="absolute left-3 top-1/2 -translate-y-1/2 h-5 w-5 text-muted-foreground" />
                <Input placeholder="Where do you want to go?" className="pl-10 h-12 text-base" />
              </div>
      ...
      <section className="py-16 bg-muted/30">
        <div className="container mx-auto px-4">
          <div className="text-center mb-12">
            ...
            <p className="text-muted-foreground text-lg">Explore cities with local guides</p>
          </div>
      ...
      <section className="py-16">
        <div className="container mx-auto px-4">
          <div className="text-center mb-12">
            ...
            <p className="text-muted-foreground text-lg">Handpicked tours loved by travelers</p>
          </div>
      ...
      <section className="py-16 bg-muted/30">
        <div className="container mx-auto px-4">
          <div className="text-center mb-12">
            <h2 className="text-3xl md:text-4xl font-bold mb-4">Explore by Interest</h2>
            <p className="text-muted-foreground text-lg">Find experiences that match your passion</p>
          </div>

          <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
            {[
              { name: "Food & Wine", icon: UtensilsCrossed, color: "bg-accent/10 text-accent" },
              { name: "History", icon: Landmark, color: "bg-primary/10 text-primary" },
              { name: "Photography", icon: Camera, color: "bg-secondary/20 text-secondary-foreground" },
              { name: "Culture", icon: Globe, color: "bg-muted text-muted-foreground" },
            ].map((category) => {
              const Icon = category.icon
              return (
                <Link key={category.name} href={`/explore?category=${category.name.toLowerCase()}`}>
      ...
      <section className="py-16">
        <div className="container mx-auto px-4">
          <div className="text-center mb-12">
            ...
            <p className="text-muted-foreground text-lg">Passionate locals ready to show you their world</p>
          </div>
                ...
                <Card className="group hover:shadow-xl transition-all duration-300">
                  <CardContent className="p-6 text-center">
                    <Avatar className="h-24 w-24 mx-auto mb-4 ring-4 ring-primary/10 group-hover:ring-primary/30 transition-all">
                      ...
                      <AvatarFallback className="text-2xl">{guide.name.charAt(0)}</AvatarFallback>
                    </Avatar>
                    <h3 className="text-xl font-semibold mb-1">{guide.name}</h3>
                    <div className="flex items-center justify-center gap-1 mb-3">
                      <Star className="h-4 w-4 fill-accent text-accent" />
                      <span className="font-semibold">{guide.rating}</span>
                      <span className="text-sm text-muted-foreground">({guide.toursGiven} tours)</span>
                    </div>
                    ...
                    <div className="text-sm text-muted-foreground">{guide.languages?.join(", ")}</div>
                  </CardContent>
                </Card>
              </Link>
            ))}
      ...
      <section className="py-16 bg-muted/30">
        <div className="container mx-auto px-4">
          <div className="text-center mb-12">
            ...
            <p className="text-muted-foreground text-lg">Start your journey in three simple steps</p>
          </div>
            ...
            {[
              {
                ...
                description: "Browse local experts based on your destination, interests, and budget",
              },
              {
                icon: Users,
                title: "Book & Connect",
                description: "Request a booking and connect with your guide to plan the perfect experience",
              },
              {
                icon: Heart,
                title: "Explore & Enjoy",
                description: "Meet your guide and discover authentic experiences you'll never forget",
              },
            ].map((step, index) => {
      ...
      <section className="py-16">
        <div className="container mx-auto px-4">
          <div className="text-center mb-12">
            ...
            <p className="text-muted-foreground text-lg">The trusted platform for authentic travel experiences</p>
          </div>
            ...
            {[
              {
                ...
                description: "All guides are verified with reviews from real travelers",
              },
              {
                icon: Shield,
                title: "Secure Booking",
                description: "Your payments are protected with our secure booking system",
              },
              {
                icon: Globe,
                title: "150+ Cities",
                description: "Find local experts in destinations around the world",
              },
              {
                icon: Heart,
                title: "24/7 Support",
      ...
      <section className="py-20 bg-gradient-to-br from-primary to-primary/80 text-primary-foreground">
        <div className="container mx-auto px-4">
          <div className="max-w-3xl mx-auto text-center space-y-6">
            <h2 className="text-3xl md:text-5xl font-bold text-balance">Ready to Become a Guide?</h2>
            <p className="text-xl text-primary-foreground/90 text-pretty">
              Share your passion, meet amazing people, and earn money showing travelers the real side of your city.
            </p>
      ...
      <section className="py-16">
        <div className="container mx-auto px-4">
          <div className="text-center mb-12">
            ...
            <p className="text-muted-foreground text-lg">Real experiences from our community</p>
          </div>
